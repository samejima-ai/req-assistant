  ...
  return (
    <>
      ...
      <button
        ...
        aria-label="メニューを開く"
        className={`fixed top-4 right-4 z-50 w-14 h-14 flex items-center justify-center rounded-full focus:outline-none transition-all duration-200 ${isOpen ? 'opacity-0 pointer-events-none scale-75' : 'opacity-100 scale-100 active:scale-90'}`}
        style={{
