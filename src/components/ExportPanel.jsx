 ...
 * ExportPanel
 *
 * 責務: 設計データ出力UI（タブ・コンテンツ・フッター）
 *
 * ExportModal（デスクトップ用オーバーレイ）と
...
export default function ExportPanel({ nodes, edges, requirementDoc, isUpdatingDoc, onUpdateRequirement, techConstraints, onUpdateTechConstraints, onClose }) {
  ...
  return (
    <div className="flex flex-col overflow-hidden">
      ...
      {/* コンテンツ */}
      <div className="flex-1 overflow-y-auto p-5 bg-gray-900 text-gray-100" style={{ maxHeight: '50vh' }}>
        {renderContent()}
      </div>
